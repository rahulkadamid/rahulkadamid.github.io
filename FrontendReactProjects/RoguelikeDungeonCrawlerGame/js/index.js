  ...
  switch (action.type) {
    case 'DAMAGE':
      return _extends({}, state, {
        entities: _extends({}, state.entities, _defineProperty({}, action.entityName, _extends({}, state.entities[action.entityName], {
    ...
    case 'ADD_ENTITY':
      return _extends({}, state, {
        occupiedSpaces: _extends({}, state.occupiedSpaces, _defineProperty({}, action.location.x + 'x' + action.location.y, action.entityName)),
        entities: _extends({}, state.entities, _defineProperty({}, action.entityName, {
    ...
    case 'RESET_BOARD':
      return _extends({}, state, {
        ...
        occupiedSpaces: _defineProperty({}, state.entities.player.x + 'x' + state.entities.player.y, 'player')
      });
    case 'SET_MAP':
      return _extends({}, state, {
        map: action.map
    ...
    case 'ADD_BOSS':
      return _extends({}, state, {
        occupiedSpaces: _extends({}, state.occupiedSpaces, (_extends8 = {}, _defineProperty(_extends8, action.location.x + 'x' + action.location.y, 'boss'), _defineProperty(_extends8, action.location.x + 1 + 'x' + action.location.y, 'boss'), _defineProperty(_extends8, action.location.x + 'x' + (action.location.y + 1), 'boss'), _defineProperty(_extends8, action.location.x + 1 + 'x' + (action.location.y + 1), 'boss'), _extends8)),
        entities: _extends({}, state.entities, {
          boss: {
            entityType: 'enemy',
            health: action.health,
...
var RogueLike = React.createClass({
  ...
  _getEmptyCoords: function _getEmptyCoords() {
    var _props$getState = this.props.getState(),
        map = _props$getState.map,
        occupiedSpaces = _props$getState.occupiedSpaces;
...
function createMap() {
  ...
  var maxRoomSize = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 20;
  var minRoomSize = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 6;
  var maxHallLength = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 5;
  var numRooms = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 20;
  var roomChance = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : .75;
  ...
  function fillRect(map, startCoord, size, fillVal) {
    for (var _i = startCoord.x; _i < startCoord.x + size.x; _i++) {
      _.fill(map[_i], fillVal, startCoord.y, size.y + startCoord.y);
    }
    return map;
  }
